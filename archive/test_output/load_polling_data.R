...
# Generated by ai-polling pipeline on 2025-07-06 20:20:58
...
load_polling_data_data <- function(format = "csv") {
  ...
  if (format == "csv") {
    ...
    data <- read_csv("test_output/polling_data_20250706_202058.csv", show_col_types = FALSE)
    ...
    if (file.exists("test_output/polling_data_20250706_202058.rds")) {
      return(readRDS("test_output/polling_data_20250706_202058.rds"))
    } else {
