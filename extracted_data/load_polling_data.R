...
# Generated by ai-polling pipeline on 2025-07-07 07:21:00
...
load_polling_data_data <- function(format = "csv") {
  ...
  if (format == "csv") {
    ...
    data <- read_csv("extracted_data/polling_data_20250707_072059.csv", show_col_types = FALSE)
    ...
    if (file.exists("extracted_data/polling_data_20250707_072059.rds")) {
      return(readRDS("extracted_data/polling_data_20250707_072059.rds"))
    } else {
